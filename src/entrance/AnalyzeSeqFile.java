...
public class AnalyzeSeqFile {
	public static void main(String[] args) throws Exception {
		...
		String[] fileList = new String[] { "data/input/中海地产公司债募集说明书-中信证券.pdf",
				"data/input/京东世纪贸易公司债募集说明书（反馈回复稿）-瑞银证券.pdf", "data/input/联想控股公司债募集说明书-银河证券.pdf",
		...
		for (String fileString : fileList) {
			...
			Util.patternGenerator(inputFilename, outputFilename, minSupport, gaps, maxLength);
